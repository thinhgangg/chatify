...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg text-muted-foreground group-data-horizontal/tabs:h-10 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "dark:[&:not([data-active])]:hover:text-white",
        ...
        "dark:data-active:border-input dark:data-active:bg-primary dark:data-active:text-primary-foreground",
